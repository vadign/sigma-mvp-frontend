...
const BOT_REPLY = `Добрый день!

Я СИГМА – фреймворк для создания и сопровождения цифровых помощников на базе ИИ, способных принимать решения, полагаясь на цифровые регламенты.

В этом чате скоро появится возможность получать консультации по вопросам муниципального управления на основе цифровых регламентов!`;
